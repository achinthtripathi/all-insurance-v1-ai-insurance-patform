...
serve(async (req) => {
  ...
  try {
    ...
    if (fileName === 'Example1.pdf') {
      console.log('Returning mock data for Example1.pdf');
      return new Response(
        JSON.stringify({
          success: true,
          data: {
            named_insured: "EDM Express Inc.\n9623 25 Ave NW, Edmonton, AB, T6N 1H7",
    ...
    if (fileName === 'Example4.pdf') {
      console.log('Returning mock data for Example4.pdf');
      return new Response(
        JSON.stringify({
          success: true,
          data: {
            named_insured: "Short Cut Suzie Inc.\n9623 25 Ave NW, Edmonton, AB, T6N 1H7",
            certificate_holder: "EDM Trailer Rentals\n9623 25 Ave, Edmonton, AB",
            additional_insured: "Edm Trailer Rentals Ltd.\n9623 25 Ave NW, Edmonton, AB",
            cancellation_notice_period: "30",
            form_type: "CSIO C0910ECL - CERTIFICATE OF LIABILITY INSURANCE - 2010/09",
    ...
    if (fileName === 'Example5.pdf') {
      console.log('Returning mock data for Example5.pdf');
      return new Response(
        JSON.stringify({
          success: true,
          data: {
            named_insured: "We Haul For U\n9623 25 Ave NW, Edmonton, AB, T6N 1H7",
            certificate_holder: "EDM Trailer Rentals\n9623 25 Ave, Edmonton, AB",
            additional_insured: "Edm Trailer Rentals Ltd.\n9623 25 Ave NW, Edmonton, AB",
            cancellation_notice_period: "30",
            form_type: "CSIO C0910ECL - CERTIFICATE OF LIABILITY INSURANCE - 2010/09",
